...
python filter_embeddings.py glove.840B.300d.txt ontonotes/train.english.jsonlines ontonotes/dev.english.jsonlines
mkdir -o ontonotes
mv glove.840B.300d.txt.filtered ontonotes/
python cache_elmo.py ontonotes/train.english.jsonlines ontonotes/dev.english.jsonlines
mv elmo_cache.hdf5 ontonotes